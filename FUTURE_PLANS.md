...
A running list of things to add to the Nuvyel landing page once the supporting
...
- [ ] **FAQ section.** Accordion answering privacy, pricing, "is it therapy?", data
      ...
      nested glass).
- [ ] **Pricing / plans.** If Nuvyel monetizes, a restrained pricing section — glass
